"""
OutfitRecommendationSkill — AI fashion stylist for coordinated outfit suggestions.

Tools:
  - search_products: find items by style/occasion/category
  - get_product_catalog: fetch the full catalog for broad selection
  - get_user_preferences: fetch user's stored style preferences
"""
import structlog
